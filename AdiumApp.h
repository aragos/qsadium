/*
 * Adium.h
 * Auto-generated file based on Adium AppleScript definitions. 
 */
...
typedef enum AdiumStatusTypes AdiumStatusTypes;

enum AdiumProxyTypes {
...
typedef enum AdiumProxyTypes AdiumProxyTypes;
...
@property BOOL enabled;  // Whether or not this account is enabled
...
@property (copy, readonly) id groups;  // The groups associated with this contact
